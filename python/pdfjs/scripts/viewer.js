...
/*
This viewer.js is originally copied from pdf.js project
 0e4d9061b22a06fd8d51872293c972ba762e03bd
 https://github.com/mozilla/pdf.js/commit/0e4d9061b22a06fd8d51872293c972ba762e03bd#diff-d41d8cd98f00b204e9800998ecf8427e
 It stays in the app directory because we did some changes to exclude the toolbar on the viewer.
 The relevant css file are in the stylesheets folder
 */
...
var PDFView = {
  ...
  initialize: function pdfViewInitialize(documentUrl) {
    var self = this;
...
//  }
  ...
  PDFView.open(PDFView.documentUrl, 0);
}
