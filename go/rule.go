...
func getFieldValue(field string) string {
    ...
    case "description": return "Fuel from caltex"
    case "price": return "200"
    case "comments": return "switched from myob"
    case "name": return "xero accounting"
    default: panic(fmt.Sprintf("Field %s is not implemented", field))
    }
}
